...
$$
$$
t_i = \sum_{j=1}^{M_i} y_{ij} \quad(\text{psu total}) \qquad
...
$$
$$
\bar t = \frac{\sum_{i\in\mathcal S} \hat t_i}{n}, \qquad
...
$$
w_{ij} = \frac{N}{n}\cdot\frac{M_i}{m_i}, \qquad \hat t_{\text{unb}} = \sum_{i\in\mathcal S}\sum_{j\in\mathcal S_i} w_{ij}y_{ij}
$$
